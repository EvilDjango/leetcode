...
import com.deerhunter.offer.Offer017;
 ...
 *
 * @author xuejunc
 * @createTime 2022/5/17 下午1:47
 */
class Offer017Test {
    private Offer017 instance = new Offer017();

    @Test
    void printNumbersToString() {
        ...
        assertEquals(expect, instance.printNumbersToString(2));
    }
}
